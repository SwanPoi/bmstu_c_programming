...
static void left_move_sort(char **left_border, char **right_border, size_t size, int (*comparator)(const void *, const void *));
static void right_move_sort(char **left_border, char **right_border, size_t size, int (*comparator)(const void *, const void *));
static void swap(void *first_object, void *second_object, size_t size);
